...
# Dump actual test code to a HIG-RunIISummer20UL18DIGIPremix-08128_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > HIG-RunIISummer20UL18DIGIPremix-08128_test.sh
#!/bin/bash
...
REPORT_NAME=HIG-RunIISummer20UL18DIGIPremix-08128_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME HIG-RunIISummer20UL18DIGIPremix-08128_1_cfg.py || exit $? ;

# Parse values from HIG-RunIISummer20UL18DIGIPremix-08128_report.xml report
...
echo "Validation report of HIG-RunIISummer20UL18DIGIPremix-08128 sequence 1/1"
...
# End of HIG-RunIISummer20UL18DIGIPremix-08128_test.sh file
EndOfTestFile

# Make file executable
chmod +x HIG-RunIISummer20UL18DIGIPremix-08128_test.sh
...
singularity run --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/HIG-RunIISummer20UL18DIGIPremix-08128_test.sh)
