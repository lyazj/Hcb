...
# Dump actual test code to a HIG-RunIISummer20UL18NanoAODv9-07464_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > HIG-RunIISummer20UL18NanoAODv9-07464_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --eventcontent NANOEDMAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --conditions 106X_upgrade2018_realistic_v16_L1v1 --step NANO --era Run2_2018,run2_nanoAOD_106Xv2 --python_filename HIG-RunIISummer20UL18NanoAODv9-07464_1_cfg.py --fileout file:HIG-RunIISummer20UL18NanoAODv9-07464.root --filein "dbs:/TTToHplusToCB_M-75_TuneCP5_13TeV-madgraph-pythia8/RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v2/MINIAODSIM" --no_exec --mc -n $EVENTS || exit $? ;

# Run generated config
REPORT_NAME=HIG-RunIISummer20UL18NanoAODv9-07464_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME HIG-RunIISummer20UL18NanoAODv9-07464_1_cfg.py || exit $? ;

# Parse values from HIG-RunIISummer20UL18NanoAODv9-07464_report.xml report
...
echo "Validation report of HIG-RunIISummer20UL18NanoAODv9-07464 sequence 1/1"
...
# End of HIG-RunIISummer20UL18NanoAODv9-07464_test.sh file
EndOfTestFile

# Make file executable
chmod +x HIG-RunIISummer20UL18NanoAODv9-07464_test.sh
...
singularity run --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/HIG-RunIISummer20UL18NanoAODv9-07464_test.sh)
