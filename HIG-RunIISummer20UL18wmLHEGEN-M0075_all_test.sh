...
[ -z "$2" ] && UPLOAD="" || UPLOAD="/eos/user/${USER:0:1}/${USER}/MiniAODStore/V0/2018/MC/HplusToCB_M-75_TuneCP5_13TeV-madgraph-pythia8/HIG-RunIISummer20UL18wmLHEGEN-M0075/$2.root"
echo "Events: ${EVENTS}"
echo "Upload: ${UPLOAD}"
